...
const Sidebar: React.FC<SidebarProps> = ({ children }) => {
    return (
        <div className="max-w-5xl w-full flex">
            <div className="max-w-[18rem] p-6 flex flex-col gap-4 w-full border-r-[#2E2E2E] border-r-2">
                <button className="sidebar-button">Главная</button>
                <button className="sidebar-button">Новый твит</button>
                <button className="sidebar-button">Мои подписки</button>
